...
<body>
    <div id="container">
        ...
        <form action="{{ route('ad-xl-doi-mat-khau') }}" class="was-validated" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" id="old-password"
                        placeholder="Nhập vào mật khẩu hiện tại" name="old_password" required>
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" id="new-password" placeholder="Nhập vào mật khẩu mới"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" id="cf-new-password"
                        placeholder="Xác nhận mật khẩu mới" name="cf_new_password" required>
                    <div class="input-group-append">
            ...
            <div class="container-btn">
                ...
                <a href="{{ route('ad-trang-chu') }}" class="btn btn-danger">Quay về trang chủ</a>
            </div>
        </form>
    </div>
