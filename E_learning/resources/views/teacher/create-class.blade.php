            ...
            <div class="create-class">
                ...
                <form action="/action_page.php" class="was-validated">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập vào tên lớp" name="ten-lop" required>
                        <div class="valid-feedback">Hợp lệ.</div>
                            <div class="invalid-feedback">Hãy điền vào trường này.</div>
                    </div>
                    <div class="form-group">
                        <label for="mo-ta">Mô tả:</label>
                        <input type="text" class="form-control" placeholder="Nhập vào mô tả" name="mo-ta">
                    </div>        
